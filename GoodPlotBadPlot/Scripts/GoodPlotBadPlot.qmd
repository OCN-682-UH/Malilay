...
# Introduction
Let's take a closer look at the [NYC Rat Sightings Dataset](https://www.kaggle.com/datasets/new-york-city/nyc-rat-sightings) produced by *The City of New York*! This dataset includes sightings of rats across all five boroughs as reported by the public to 3-1-1 in NYC from 2010-2017. We're going to explore these sightings across the boroughs to answer the following questions:
...
```{r combined-bad-plots, echo=TRUE, message=FALSE, warning=FALSE, fig.cap="We're not looking too good", fig.width = 8, fig.height = 8}
...
### A MUCH BETTER PLOT
```{r combined-good-plots, echo=TRUE, message=FALSE, warning=FALSE, fig.cap="Rat sightings in NYC from 2010-2017 & Sightings across the boroughs in 2016", fig.width = 8, fig.height = 8}
